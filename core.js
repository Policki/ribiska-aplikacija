...
function enhancePageIntroWithModuleIcon(moduleKey) {
  ...
  const moduleIcons = {
    ...
    statistika: "slike/statistika.png",
...
function renderAppNav(user, activeKey) {
  ...
  const modules = [
    ...
    { key: "pristopna-izjava", label: "PRISTOPNA IZJAVA", href: "pristopna-izjava.html" },
    ...
    { key: "statistika", label: "STATISTIKA", href: "statistika.html" },
